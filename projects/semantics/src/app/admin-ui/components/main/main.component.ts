...
import { colDefsType } from '../../../shared/models/colDefsType';
import { tableColOption } from '../../../shared/models/tableColOption';
...
export class MainComponent implements OnInit {
  tableOption: tableColOption = {
    colDefs: [
      { field: 'id', headerName: '', type: colDefsType.Select },
